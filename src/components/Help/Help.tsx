    ...
    <div className='mt-24 flex mb-10 gap-16 flex-col-reverse lg:flex-row'>
      ...
      <div className='flex-1 flex flex-col justify-between space-y-10'>
        <div className='flex-grow'>
          {' '}
          {/* This div takes equal space */}
          <h1 className='text-5xl font-bold'>You can do this. We can help.</h1>
          <p className='font-semibold text-2xl mt-16   leading-loose		 '>
            We believe anyone with the passion and drive to become a doctor
            should have the opportunity to do so. That's why we offer financial
            aid to those who qualify, and support services to help you succeed
          </p>
        </div>
